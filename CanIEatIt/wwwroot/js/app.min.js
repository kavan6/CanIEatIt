...
</svg></div>`;n=n.substring(0,n.length-1);const u=`<input type="hidden" value="${n}" name="SearchKeyWords"></input>`;return t.innerHTML=i+r+u,t}if(n.value==" ")return n.value="",null;n.parentNode.appendChild(t(n.value),n);n.value=""}function removeNodeLabel(n){n.parentNode.remove()}function temp(){}function wipeInputBox(n){(n.value=="Keywords..."||n.value=="Name...")&&(n.value="")}function fillInputBox(n){n==document.getElementById("input-keywords")&&""==document.getElementById("input-keywords").value?n.value="Keywords...":n==document.getElementById("input-name")&&""==document.getElementById("input-name").value&&(n.value="Name...")}function checkAll(n){var r=n.id,i,t;switch(r){case"location-check-default":i=document.getElementsByClassName("location-check");break;case"family-check-default":i=document.getElementsByClassName("family-check")}if(n.checked)for(t=0;t<i.length;t++)i[t].checked=!0;else for(t=0;t<i.length;t++)i[t].checked=!1}function setValueHidden(n){var t=n.id+"-hidden",i=n.id.substring(6);document.getElementById(t).value=i+","+n.checked}window.addEventListener("keyup",function(n){n.key==" "&&n.target==document.getElementById("input-keywords")&&createLabel(n.target)});window.addEventListener("focusin",function(n){n.target.classList[1]=="search-form-input"&&wipeInputBox(n.target)});window.addEventListener("focusout",function(n){n.target.classList[1]=="search-form-input"&&fillInputBox(n.target)});